...
namespace larlite {
  ...
  void ExecuteCompression::CalculateCompression(const std::vector<short> &beforeADCs,
    ...
    if (pl==0){
      ...
      _compressionU_huff += postHuffTicks/inTicks;//Anya variable
      _NplU += 1;
    }
    else if (pl==1){
      _compressionV += outTicks/inTicks;
      _compressionV_huff += postHuffTicks/inTicks;//Anya variable
      _NplV += 1;
    }
    else if (pl==2){
      _compressionY += outTicks/inTicks;
      _compressionY_huff += postHuffTicks/inTicks;//Anya variable
      _NplY += 1;
    }
    else
    ...
    //Anya variables:
    _ch_compression_huff = postHuffTicks/inTicks;
    _compression_huff += postHuffTicks/inTicks;

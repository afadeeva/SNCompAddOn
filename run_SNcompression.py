...
for x in xrange(len(sys.argv)-4):
    ...
    my_proc.set_ana_output_file(sys.argv[-3]) #this is the output_ana root file, third from last entry in the command line
    my_proc.set_output_file(sys.argv[-2])   #this is the compressed waveforms root file, second from last entry in the command line
